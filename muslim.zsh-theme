...
PROMPT_MUSLIM_SYMBOL_GIT_REPO=${PROMPT_MUSLIM_SYMBOL_GIT_REPO:-"git"}
PROMPT_MUSLIM_SYMBOL_GIT_REPO_DELIMITER=${PROMPT_MUSLIM_SYMBOL_GIT_REPO_DELIMITER:-":"}
...
PROMPT_MUSLIM_COLOR_GIT_REPO=${PROMPT_MUSLIM_COLOR_GIT_REPO:-"blue"}
...
prompt_muslim_part_git() {
  ...
  if git rev-parse --git-dir > /dev/null 2>&1; then
    ...
    local git_repo="$(prompt_muslim_color $PROMPT_MUSLIM_COLOR_GIT_REPO $PROMPT_MUSLIM_SYMBOL_GIT_REPO)$PROMPT_MUSLIM_SYMBOL_GIT_REPO_DELIMITER"

    export PROMPT_MUSLIM_STR_GIT_LEFT="${git_repo}${branch}${time}"
